			...
			<div className="relative w-auto my-6 mx-auto max-w-3xl">
				<div className="p-5 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
					<div className="flex justify-between pb-3">
						...
						<div className="px-3 py-3 border rounded max-w-max h-fit text-gray-200 bg-gray-700 hover:text-white hover:bg-gray-500 cursor-pointer">
							<XMarkIcon aria-hidden="true" className="h-4 w-4" onClick={() => closeModal()}/>
						</div>
					</div>
					<hr className="mb-3 h-0.5 border-t-0 bg-gray-200" />
